...
class ActorNetwork(nn.Module):
    def __init__(self, n_actions, input_dims, alpha,
        ...
        self.checkpoint_file = 'actor_torch_ppo'
    ...
    def save_checkpoint(self, name):
        T.save(self.state_dict(), self.checkpoint_file + f"_{name}")

    def load_checkpoint(self, name):
        self.load_state_dict(T.load(self.checkpoint_file + f"_{name}"))


class CriticNetwork(nn.Module):
    def __init__(self, input_dims, alpha, fc1_dims=256, fc2_dims=64):
